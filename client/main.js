...
//import  { Mongo } from 'meteor/mongo';//bd
import './main.html';
//import { Tasks } from '../api/tasks.js';//BD
if (Meteor.isClient){

Game = new Mongo.Collection('canvas');
...
Template.botonGuardar.events({
  'click button'(event, instance) {
   
   console.log("implementar guardar juego..");
  },
});
